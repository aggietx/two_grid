...
n=5;Ny=12;Nz=17;Nx=44;h=.1; nx=Nx*n;ny=Ny*n;nz=Nz*n;Lx=h*nx;Ly=h*ny;Lz=h*nz;hx=h;hy=h;hz=h;  
...
%% model
load spe10;K=spe10(1:ny,end-nz+1:end,1:nx)*10^(15);%%% last nz layers
